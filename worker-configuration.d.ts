/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: c40178b516a45ffb99d7c23466ffbb60)
// Runtime types generated with workerd@1.20250917.0 2025-09-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
	}
	interface Env {
		FROM_EMAIL: "contact@messaging.portcityai.com";
		FROM_NAME: "React Router Boilerplate" | "Template App";
		SUPPORT_EMAIL: "support@example.com";
		DEV_MODE: "true" | "false";
		CLERK_JWT_ISSUER_DOMAIN: string;
		VITE_CLERK_PUBLISHABLE_KEY: string;
		CLERK_SECRET_KEY: string;
		CLERK_OAUTH_TOKEN: string;
		CLERK_OAUTH_CLIENT_ID: string;
		ENVIRONMENT: string;
		VITE_CLERK_TEST_EMAIL: string;
		VITE_CLERK_TEST_PASSWORD: string;
		VITE_CLERK_TENANT_PASSWORD: string;
		VITE_CLERK_TENANT_USER: string;
		VITE_CLERK_AGENCY_USER: string;
		VITE_CLERK_AGENCY_PASSWORD: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FROM_EMAIL" | "FROM_NAME" | "SUPPORT_EMAIL" | "DEV_MODE" | "CLERK_JWT_ISSUER_DOMAIN" | "VITE_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "CLERK_OAUTH_TOKEN" | "CLERK_OAUTH_CLIENT_ID" | "ENVIRONMENT" | "VITE_CLERK_TEST_EMAIL" | "VITE_CLERK_TEST_PASSWORD" | "VITE_CLERK_TENANT_PASSWORD" | "VITE_CLERK_TENANT_USER" | "VITE_CLERK_AGENCY_USER" | "VITE_CLERK_AGENCY_PASSWORD" | "VITE_CONVEX_URL" | "CONVEX_DEPLOYMENT">> {}
}
